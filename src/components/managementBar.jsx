    ...
    return (
        <div className="flex w-4xl mb-4.5">
            <div className="flex mt-4.5">
                ...
                />
                <button className="border-2 border-ellGray hover:border-ellPrimary rounded-2xl py-2 mr-2 w-22 font-prompt text-ellPrimary cursor-pointer">ทั้งหมด</button>
                <button className="border-2 border-ellGray hover:border-ellPrimary rounded-2xl py-2 mr-2 w-22 font-prompt text-ellPrimary flex flex-row justify-center items-center cursor-pointer">
